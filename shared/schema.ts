...
// ============================================================================
// BACKWARD COMPATIBILITY TABLE (for existing code)
// ============================================================================
...
// Type exports for existing storage.ts and other files
export type User = typeof users.$inferSelect;
export type Business = typeof businesses.$inferSelect;
export type Product = typeof products.$inferSelect;
export type Post = typeof posts.$inferSelect;
export type Comment = typeof comments.$inferSelect;
export type SavedComment = typeof boardItems.$inferSelect; // Saved comments now part of boards

export type InsertUser = typeof users.$inferInsert;

// Combined Feed Item for Masonry Layout (backward compatibility)
