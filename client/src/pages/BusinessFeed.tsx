...
import { Heart, MessageCircle, Share2, Bookmark, UserPlus, Search as SearchIcon } from "lucide-react";
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border/50">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-lg font-bold">Business Feed</h1>
              <p className="text-xs text-muted-foreground">Discover other businesses</p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              data-testid="input-search-business-feed"
            />
          </div>
        </div>
      </header>
